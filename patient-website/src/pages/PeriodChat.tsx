...
import { usePeriodChat } from "../hooks/usePeriodChat";
import { useVoiceInput } from "../hooks/useVoiceInput";
import { useTranslation } from "../hooks/useTranslation";
import { useApp } from "../context/AppContext";

const STANDARD_QUESTIONS = [
  { text: "My periods are irregular / मेरे मासिक धर्म अनियमित हैं", intent: "disease" },
  { text: "I have heavy bleeding and severe pain / मुझे बहुत ब्लीडिंग और दर्द हो रहा है", intent: "emergency" },
  { text: "Is it normal to miss a period? / क्या मासिक धर्म मिस होना सामान्य है?", intent: "disease" }
];
...
export default function PeriodChat() {
  ...
  const { chatHistory, sendMessage, clearChat } = usePeriodChat();
